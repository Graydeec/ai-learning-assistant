 ...
 * @return {Promise<Array<{question: string, options: Array, correctAnswer: string, explaination: string, difficulty: String}>>}
 */
export const generateQuiz = async (text, numQuestions = 5) => {
  const prompt = `Generate exactly ${numQuestions} multiple choice questions from the following text.
    ...
    E: [Brief explanation]
    D: [Diffculty: easy, medium, or hard]
 ...
 * @param {Array<Object>} chunks = kRelevant document chunks
 * @returns {Promise<string>}
 */
