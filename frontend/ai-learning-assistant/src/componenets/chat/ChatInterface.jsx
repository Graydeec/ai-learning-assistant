...
const ChatInterface = () => {
  ...
  const scrollToBottom = () => {
    messagesEndRef.current?.scrollIntoView({ behevior: "smooth" });
  };
  ...
  const renderMessage = (msg, index) => {
    ...
    return (
      ...
      >
        ...
        {isUser && (
          <div className="w-9 h-9 rounded-xl bg-linear-to-r from-slate-200 to-slate-300 flex items-center justify-center text-slate-700 font-semibold text-sm shrink-0 shadow-sm">
  ...
  if (initialLoading) {
    return (
      <div className="flex flex-col h-[70vh] bg-white/80 backdrop-blur-xl border border-slate-200/60 rounded-xl items-center justify-center shadow-lg shadow-slate-200/50">
