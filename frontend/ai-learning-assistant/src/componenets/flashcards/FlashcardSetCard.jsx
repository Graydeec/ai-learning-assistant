import { BookOpen, Sparkles, SparklesIcon, TrendingUp } from "lucide-react";
...
const FlashcardSetCard = ({ flashcardSet }) => {
  ...
  const progressPercentage =
    totalCards > 0 ? Math.round((reviewedCount * 100) / totalCards) : 0;
    ...
    >
      <div className="space-y-4">
        ...
        <div className="flex items-start gap-4">
          <div className="shrink-0 w-12 h-12 rounded-xl bg-linear-to-br from-emerald-100 to-teal-100 flex justify-center items-center">
