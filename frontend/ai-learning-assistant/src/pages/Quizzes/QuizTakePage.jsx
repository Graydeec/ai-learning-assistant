              ...
              <label
                ...
                className={`group relative flex items-center p-3 border-2 rounded-xl cursor-pointer transition-all duration-200 ${
                  isSelected
                    ...
                    : "border-slate-200 bg-slate-50/50 hover:border-slate-300 hover:bg-white hover:shadow-lg"
                }`}
              >
                <input
                  type="radio"
                ...
                {/* Option Text */}
                <span
                  className={`ml-4 tex-sm font-medium transition-colors duration-200 ${
                    isSelected
                      ? "text-emerald-900"
      ...
      <div className="flex items-center justify-between gap-4">
        ...
        {currentQuestionIndex === quiz.questions.length - 1 ? (
          <button
            ...
            disabled={submitting}
            className="group relative px-8 h-12 bg-linear-to-r from-emerald-500 to-teal-500 hover:from-emerald-600 hover:to-teal-600 text-white font-semibold text-sm rounded-xl transition-all duration-200 active:95 disabled:opacity-50 disabled:cursor-not-allowed disabled:active:scale-100 overflow-hidden"
          >
